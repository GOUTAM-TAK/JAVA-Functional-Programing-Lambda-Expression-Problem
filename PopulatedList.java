...
public class PopulatedList {
	public static Map<String ,Publication> populatedMap(Map<String ,Publication> list)
	{
		...
		list.put("Panchtantra" , new Tape("Panchtantra",500,LocalDate.parse("2016-02-01"),(short) 8,LocalTime.parse("23:12:15")));
		list.put("Vetal" , new Tape("Vetal",200,LocalDate.parse("2016-02-01"),(short) 9,LocalTime.parse("15:10:15")));
	//	list.put("Geeta " , new Book("Geeta",1000,LocalDate.parse("2023-02-01"),(short) 8,1000));
	//	list.put("Geeta " , new Book("Geeta",1000,LocalDate.parse("2023-02-01"),(short) 8,1000));
